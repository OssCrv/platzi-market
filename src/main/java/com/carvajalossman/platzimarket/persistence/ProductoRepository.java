...
import com.carvajalossman.platzimarket.persistence.crud.ProductoCrudRepository;
import com.carvajalossman.platzimarket.persistence.entity.Producto;
import com.carvajalossman.platzimarket.persistence.mapper.ProductMapper;
...
public class ProductoRepository implements ProductRepository {
  ...
  public Optional<List<Product>> getByCategory(int categoryId) {
    List<Producto> productos = productoCrudRepository.findByIdCategoriaOrderByNombreAsc(
      categoryId
    );
